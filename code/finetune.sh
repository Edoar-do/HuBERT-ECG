...
python finetune.py 3 path/to/ptb_small_train_0.csv path/to/ptb_small_train_0.csv 14 1 64 auroc --load_path=path/to/hubert_ecg_small.pt --training_steps=70000 --downsampling_factor=5 --label_start_index=3 --use_loss_weights --transformer_blocks_to_unfreeze=8 --model_dropout_mult=-2 --val_interval=50 --finetuning_layerdrop=0.0 --random_crop --wandb_run_name=SMALL_ptb_small0
python finetune.py 3 path/to/ptb_small_train_1.csv path/to/ptb_small_train_1.csv 14 1 64 auroc --load_path=path/to/hubert_ecg_small.pt --training_steps=70000 --downsampling_factor=5 --label_start_index=3 --use_loss_weights --transformer_blocks_to_unfreeze=8 --model_dropout_mult=-2 --val_interval=50 --finetuning_layerdrop=0.0 --random_crop --wandb_run_name=SMALL_ptb_small1
python finetune.py 3 path/to/ptb_small_train_2.csv path/to/ptb_small_train_2.csv 14 1 64 auroc --load_path=path/to/hubert_ecg_small.pt --training_steps=70000 --downsampling_factor=5 --label_start_index=3 --use_loss_weights --transformer_blocks_to_unfreeze=8 --model_dropout_mult=-2 --val_interval=50 --finetuning_layerdrop=0.0 --random_crop --wandb_run_name=SMALL_ptb_small2
python finetune.py 3 path/to/ptb_small_train_3.csv path/to/ptb_small_train_3.csv 14 1 64 auroc --load_path=path/to/hubert_ecg_small.pt --training_steps=70000 --downsampling_factor=5 --label_start_index=3 --use_loss_weights --transformer_blocks_to_unfreeze=8 --model_dropout_mult=-2 --val_interval=50 --finetuning_layerdrop=0.0 --random_crop --wandb_run_name=SMALL_ptb_small3
