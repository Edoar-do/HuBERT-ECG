...
python finetune.py 3 /proj/rep-learning-robotics/users/x_nonra/HuBERT-ECG/reproducibility/ptbxl/ptbxl_all_train.csv /proj/rep-learning-robotics/users/x_nonra/HuBERT-ECG/reproducibility/ptbxl/ptbxl_all_val.csv 71 8 64 auroc \
    --load_path=/proj/rep-learning-robotics/users/x_nonra/HuBERT-ECG/models/hubert-ecg-small.pt \
