...
📢 [SSL Pretrained and Finetuned Models](https://huggingface.co/Edoardo-Coppola) on Hugging Face 🤗
...
## Model weights
All our models, SSL pretrained and finetuned, are accessible on Hugging Face 🤗 [(https://huggingface.co/Edoardo-Coppola)] under CC BY-NC 4.0 license
